    ...
    ***************************************************************************** */
    ...
    const handleChatActionClick = (editor, id, content) => {
        switch (id) {
            case 'insert':
                ...
                editor.selection.setContent(`this is a test ${new Date()}`);
    ...
    pluginManager.add('craftercms_openai', function (editor) {
        ...
        editor.ui.registry.addButton('chatgptdialog', {
            ...
            onAction(api) {
                const buttonElement = editor.dom.select('.tox-tbtn')[0];
                console.log(buttonElement);
                // editor.fire('contextmenu', {
                //     target: buttonElement, // The element relative to which the menu is displayed
                //     relative: buttonElement, // Use relativeTarget to position the context menu
                // });
